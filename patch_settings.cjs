...
// Replace icon styles
code = code.replace(/bg-emerald-500\/20 border border-emerald-500\/40 flex items-center justify-center text-emerald-400/g, 'bg-neutral-800 border border-neutral-700 flex items-center justify-center text-neutral-300');
