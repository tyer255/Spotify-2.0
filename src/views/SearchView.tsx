...
export const SearchView: React.FC<SearchViewProps> = ({
  ...
  const processSearchResults = useCallback(
    ...
    [profile?.recentHistory, profile?.interactionStats, likedTrackIds, followedArtistIds, followedArtistNames]
  );
              ...
              {filteredLanguages.map((lang) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group relative p-4 rounded-2xl border border-white/10 shadow-lg cursor-pointer overflow-hidden flex flex-col justify-between min-h-[110px] sm:min-h-[125px] transition-all"
                  >
                        ...
                        <img
                          src={
                            results.topResult.type === 'track'
                              ...
                              : (results.topResult.data as any).images?.large || (results.topResult.data as any).images?.medium || (results.topResult.data as any).image || 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&auto=format&fit=crop&q=80'
                          }
                          alt="Top Result"
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1 flex-shrink-0">
                          ...
                          >
                            {isLiked ? <Check className="w-4 h-4" /> : <Plus className="w-4 h-4" />}
                          </button>
                        </div>
                      </div>
                    );
